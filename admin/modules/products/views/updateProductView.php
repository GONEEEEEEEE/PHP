                ...
                <div id="wp-post">
                    ...
                    <div class="section-detail">
                        ...
                        <form method="POST" id="form-create" enctype="multipart/form-data">
                            <input type="hidden" name="id" id="id" value="<?php set_value('product_id'); ?>">
                            ...
                            <div id="featured">
                                <input type="radio" name="featured" <?php is_featured($result['is_featured'], "no"); ?> id="no" value="no">
                                <label for="no">Bình thường</label>
                                <input type="radio" name="featured" <?php is_featured($result['is_featured'], "yes"); ?> id="yes" value="yes">
                            ...
                            <div id="uploadFile">
                                ...
                                <img id="imgPreview1" name="1" src="public/images/img-thumb.png" alt="Hình ảnh thumb">
                                <img id="imgPreview2" name="2" src="public/images/img-thumb.png" alt="Hình ảnh thumb">
                                <img id="imgPreview3" name="3" src="public/images/img-thumb.png" alt="Hình ảnh thumb">
                                <img id="imgPreview4" name="4" src="public/images/img-thumb.png" alt="Hình ảnh thumb">
                                <img id="imgPreview5" name="5" src="public/images/img-thumb.png" alt="Hình ảnh thumb">
                            ...
                            <select name="status">
                                ...
                                <option value="public" <?php get_category_status("product_status", "public") ?>>Công
                                    khai</option>
                                <option value="inactive" <?php get_category_status("product_status", "inactive") ?>>Chờ
                                    duyệt</option>
                                <option value="out_of_stock" <?php get_category_status("product_status", "out_of_stock") ?>>Hết hàng</option>
                                <option value="trash" <?php get_category_status("product_status", "trash") ?>>Thùng rác
                                </option>
                            </select>
...
<script>
    $(document).ready(function () {
        $(window).load(function () {
            ...
            $.ajax({
                type: "POST",
                url: "?mod=products&action=getImagesUpdateAjax",
                data: data,
                dataType: "json",
                success: function (data) {
                    ...
                    Object.values(data).forEach(item => {
                        if(item.pin == 1){
                            $('#imgPreview' + (index)).addClass("active");
                        }
                        $('#imgPreview' + (index)).attr('src', "../public/images/" + item.file_name).show();
                        index++;
                    });
                }
            });
